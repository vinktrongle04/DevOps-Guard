...
const GOOGLE_MAPS_KEY = "AIzaSyBcDeFgHiJkLmNoPqRsTuVwXyZ1234567890";

// ❌ [AI-001] Security Trap — Hardcoded OpenAI API Key
const OPENAI_API_KEY = "sk-proj-MOCK00000000000000000000000000000000000000000000";

// ❌ [COM-003] Security Trap — Hardcoded Slack Bot Token
const SLACK_WEBHOOK = "xoxb-123456789012-1234567890123-AbCdEfGhIjKlMnOpQrStUvWx";

// ❌ [GEN-003] Security Trap — Hardcoded Internal API Server IP
const API_SERVER = "http://192.168.1.100:8080";
