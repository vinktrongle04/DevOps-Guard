...
[GitHub issue](https://github.com/vinktrongle04/DevOps-Guard/issues) or, for
reports you'd prefer to keep private, via GitHub's private vulnerability
reporting flow described in [SECURITY.md](SECURITY.md) (it works for any
sensitive report, not only security bugs). All complaints will be reviewed
